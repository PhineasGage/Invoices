...
public class SqlQueriesProvider {
  ...
  public static final String NAMED_PARAMETERS_FOR_INSURANCE_UPDATE =
      "issue_date = :issue_date, "
          + "type = :type, "
          + "amount = :amount, "
          + "nip = :nip "
  ...
  public static final String INSERT_INTO_COMPANY = "INSERT INTO Company (name, nip, street, postal_code, city, discount, is_active, tax_type) "
      + "VALUES (:name,:nip, :street, :postal_code, :city, :discount, :is_active, :tax_type) RETURNING id;";

  public static final String INSERT_INTO_INVOICE_ENTRY = "INSERT INTO invoice_entry ( description, vat_rate, net_price, quantity, category) "
      + "VALUES ( :description,:vatRate, :netPrice, :quantity, :category) RETURNING id;";
  ...
  public static final String INSERT_INTO_INSURANCE = "INSERT INTO Insurance (issue_date, type, amount, nip)"
      + "VALUES (:issue_date, :type, :amount, :nip) RETURNING id";
  ...
  public static final String DELETE_FROM_INSURANCE_GIVEN_INSURANCE_ID = " DELETE FROM Insurance WHERE Id = ";

  public static final String DELETE_INVOICE = "DELETE FROM Invoice";

  public static final String DELETE_INSURANCE = "DELETE FROM Insurance";
